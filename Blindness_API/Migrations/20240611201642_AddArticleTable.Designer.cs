...
namespace Blindness_API.Migrations
{
    ...
    [Migration("20240611201642_AddArticleTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blindness_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Blindness_API.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blindness_API.Models.Result", b =>
                {
                    b.HasOne("Blindness_API.Models.LocalUser", null)
                        .WithMany("Results")
                    ...
                    b.HasOne("Blindness_API.Models.ApplicationUser", "User")
                        .WithMany("Results")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Blindness_API.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
